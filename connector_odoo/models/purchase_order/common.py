...
class OdooPurchaseOrder(models.Model):
    ...
    def _set_purchase_state(self):
        ...
        # Picking will be imported later, delete all moves generated by Odoo
        delete_moves = self.odoo_id.state == "draft"
        self.odoo_id.onchange_partner_id()
        ...
        if delete_moves:
            picking_ids = self.odoo_id.picking_ids
            move_ids = self.odoo_id.picking_ids.mapped("move_lines")
